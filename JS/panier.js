...
function recupobj() {
    ...
    if (isNaN(nbps5)==false){
        for (k=0;k<=nbps5;k++){
            ...
            `<img style='float:right;height:170px;margin-left:130px' src='' id=tableBannerps5${k} />` +  "<br>"
    ...
    if (isNaN(nbxbox)==false){
        for (p=0;p<=nbxbox;p++){
            ...
            `<img style='float:right;height:170px;margin-left:130px' src='' id=tableBannerxbox${p} />` + "<br>"
    ...
    if (isNaN(nbswitch)==false){
        for (i=0;i<=nbswitch;i++){
            ...
            `<img style='float:right;height:190px;margin-left:90px' src='' id=tableBannerswitch${i} />` + "<br>"
